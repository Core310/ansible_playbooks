...
1.  **Check Health**: Run `node "$HOME/.agy/get-shit-done/bin/gsd-tools.cjs" validate health` and `node "$HOME/.agy/get-shit-done/bin/gsd-tools.cjs" validate consistency`. Identify any project inconsistencies, stale branches, or planning gaps.
